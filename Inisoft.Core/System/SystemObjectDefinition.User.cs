...
namespace Inisoft.Core
{
    internal partial class SystemObjectDefinition
	{
        internal static ObjectDefinition ObjectDefinition_User()
        {
            ...
            result.Properties.Add(new PropertyDefinition() { Name = "FirstName", Title = "First Name", PropertyType = PropertyTypeEnum.Text, MaxLength = 50, IsRequired = true });
            result.Properties.Add(new PropertyDefinition() { Name = "LastName", Title = "Last Name", PropertyType = PropertyTypeEnum.Text, MaxLength = 50, IsRequired = true });
            result.Properties.Add(new PropertyDefinition() { Name = "Email", Title = "Email", PropertyType = PropertyTypeEnum.Text, MaxLength = 150, IsRequired = true });
            result.Properties.Add(new PropertyDefinition() { Name = "Password", Title = "Password", PropertyType = PropertyTypeEnum.Password });
            result.Properties.Add(new PropertyDefinition() { Name = "Nick", Title = "Nick", PropertyType = PropertyTypeEnum.Text, MaxLength = 50 });
            ...
            result.Properties.Add(new PropertyDefinition() { Name = "LastLoginDate", Title = "Last login date", PropertyType = PropertyTypeEnum.DateTime });
