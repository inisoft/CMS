...
namespace Inisoft.Core
{
    internal partial class SystemObjectDefinition
	{
        internal static ObjectDefinition ObjectDefinition_ObjectType()
        {
            ...
            result.Properties.Add(new PropertyDefinition() { Name = "Name", Title = "Name", PropertyType = PropertyTypeEnum.Text, MaxLength = 50, IsRequired = true });
            result.Properties.Add(new PropertyDefinition() { Name = "CodeName", Title = "Code Name", PropertyType = PropertyTypeEnum.Text, MaxLength = 50, IsRequired = true });
